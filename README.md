# Smart Bank (C)
# 👋 Hi, I’m Anthony Mjomba Potua  

🎓 Aspiring **Actuary** | 💻 Beginner **Software Developer** | 📊 Passionate about **Data & Finance**  

---

## 🚀 About Me
- 🌱 Currently learning **C, Python, and actuarial applications of programming**  
- 🤖 Exploring **AI & machine learning** for financial systems  
- 📊 Interested in risk modeling, data analysis, and automation  
- 🎯 Goal: To merge **actuarial science + technology** and build intelligent financial solutions  

---

## 🛠 Tech Stack
- **Languages:** C, Python (learning)  
- **Tools:** GitHub, Pandas, NumPy, Scikit-learn (beginner level)  
- **Focus Areas:** Financial modeling, forecasting, risk analysis  

---

## 📂 Featured Projects
- 🏦 [SmartBank-C](https://github.com/yourusername/SmartBank-C) — A C-based banking system simulation  
- 🤖 Forex AI Bot (Work in progress) — Exploring ML-driven forex trading  
